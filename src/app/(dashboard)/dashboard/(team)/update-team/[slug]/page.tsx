...
import { useHandleFindSingleTeamQuery, useHandleUpdateTeamMutation } from "@/redux/features/team/teamApi";
...
const UpdatePage: React.FC<{ params: Promise<Params> }> = ({ params }) => {
  ...
  const [handleUpdateTeam, { isLoading }] = useHandleUpdateTeamMutation();
  ...
  const { data } = useHandleFindSingleTeamQuery(slug);
  let updatedImage = data?.payload?.image;
  // image
  ...
  const onSubmit: SubmitHandler<IFormInput> = async () => {
    ...
    try {
      ...
      await handleUpdateTeam(payload).unwrap();
  ...
  return (
    <div>
      <Heading
        title="Update Team"
        subTitle="Please update your team content."
      />
      <FormProvider {...methods}>
        ...
        >
          ...
          >
            {isLoading || isImageUploading ? "Please Wait..." : "Update Team"}
          </Button>
